...
newLists = ["Joker" , 1 , 4 , 7 , "Batman" , 9 , 10 , 11 , "Robin"]
print(newLists)
...
avengers = ["hawkeye" ,"hulk", "black panther", "Cap America"]
...
marvel.append("Ant Man")
print(marvel)
marvel.reverse()
print(marvel)
marvel.remove("Cap America")
print(marvel)
